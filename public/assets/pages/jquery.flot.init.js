...
! function($) {
	...
	FlotChart.prototype.init = function() {
		...
		var datas = [20, 30, 15];
		var colors = ["#f1d06d", "#d97c7c", "#c5e3fa"];
		...
		var donutcolors = ["#2d3b63", "#ebeff2", "#a7b3bc", "#2577b5"];
